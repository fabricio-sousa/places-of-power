$(document).ready(function() {
    ...
    function geocodePlace(geocoder, place, placesMap) {
        ...
        geocoder.geocode({
            ...
            if (status === 'OK') {
                placesMap.setCenter(results[0].geometry
                    .location);
                ...
                google.maps.event.addListener(place
                    .marker,
                    'click',
                    function() {
                        placetext(place);
                ...
                alert(
                    'This location has an invalid address.'
                );
            }
        });
    }
    ...
    function placetext(place) {
        ...
        if (infoWindow.marker != place.marker) {
            ...
            infoWindow.setContent(
                '<div class="infoWindow"><h5>' + place.name +
                '</h5><br><h6>' + place.description +
                '<br><br>Added by ' + place.creator +
                ' <br>on ' + place.date + '</h6)');
        };
    }
});